...
open_quizz_db_data = (
    ...
    ("Bande dessinnée", "Tintin", "https://www.kiwimedddd.com/oqdb/files/2124627384/OpenQuizzDB_124/openquizzdb_124.json"),
...
def generate_json_file(categorie, titre, url):
    ...
    try:
        ...
        try:
            ...
            print("Exception dans la désérialisation ou l'utilisation des données (questionnaire: " + titre + ", url: " + url)
